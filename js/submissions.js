  ...
  function showSubmissionCenter() {
    ...
    target.innerHTML = `
      <div class="submission-page">
        ...
        <header class="submission-hero"><span class="submission-hero__icon">${UI().icon("file-plus-2")}</span><div><h1>Submission Center</h1><p>Submit formatted resources, SOP changes, Important News, and Macro Updates for review.</p><a class="submission-backup-link" href="/backup">${UI().icon("files")} Open Backup Document</a></div></header>
